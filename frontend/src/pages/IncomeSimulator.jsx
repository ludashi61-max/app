...
const IncomeSimulator = () => {
  ...
  return (
    <div className="min-h-screen page-bg py-12" style={{ backgroundImage: "url('/images/income-tokyo-night.jpg')" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-4">Part-Time Income Simulator</h1>
