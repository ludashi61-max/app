...
const CostCalculator = () => {
  ...
  return (
    <div className="min-h-screen page-bg py-12" style={{ backgroundImage: "url('/images/calculator-tokyo-residential.jpg')" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-4">4-Year Cost Calculator</h1>
